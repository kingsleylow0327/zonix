...
class APIException(Exception):
    ...
    def __init__(self, response):
        ...
        try:
            ...
            self.message = 'Invalid JSON error message from billance: {}'.format(response.text)
        else:
...
class RequestException(Exception):
    ...
    def __str__(self):
        return 'BillanceRequestException: %s' % self.message
...
class ParamsException(Exception):
    ...
    def __str__(self):
        return 'BilllanceParamsException: %s' % self.message
